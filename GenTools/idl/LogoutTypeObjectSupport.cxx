        ...
        TypeIdentifierPair& type_ids_Logout)
{
    ...
    return_code_Logout =
        ...
        "DistributedATS_Logout::Logout", type_ids_Logout);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Logout)
    {
        StructTypeFlag struct_flags_Logout = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_Logout = "DistributedATS_Logout::Logout";
        ...
        }
        {
            ...
            ann_custom_Logout.reset();
            CompleteMemberDetail detail_DATS_Source = TypeObjectUtils::build_complete_member_detail(name_DATS_Source, member_ann_builtin_DATS_Source, ann_custom_Logout);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_Logout, member_DATS_Source);
        }
        {
            ...
            ann_custom_Logout.reset();
            CompleteMemberDetail detail_DATS_Destination = TypeObjectUtils::build_complete_member_detail(name_DATS_Destination, member_ann_builtin_DATS_Destination, ann_custom_Logout);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_Logout, member_DATS_Destination);
        }
        {
            ...
            ann_custom_Logout.reset();
            CompleteMemberDetail detail_DATS_SourceUser = TypeObjectUtils::build_complete_member_detail(name_DATS_SourceUser, member_ann_builtin_DATS_SourceUser, ann_custom_Logout);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_Logout, member_DATS_SourceUser);
        }
        {
            ...
            ann_custom_Logout.reset();
            CompleteMemberDetail detail_DATS_DestinationUser = TypeObjectUtils::build_complete_member_detail(name_DATS_DestinationUser, member_ann_builtin_DATS_DestinationUser, ann_custom_Logout);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_Logout, member_DATS_DestinationUser);
        }
        {
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedATS_Logout::Logout already registered in TypeObjectRegistry for a different type.");
        }
    }
}
