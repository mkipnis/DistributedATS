...
namespace DistributedATS_MarketDataIncrementalRefresh {
    ...
    {
        set_name("DistributedATS_MarketDataIncrementalRefresh::NoMDEntries");
        uint32_t type_size = DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_max_cdr_typesize;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
        uint32_t key_length = DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_max_key_cdr_typesize > 16 ? DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_max_key_cdr_typesize : 16;
    ...
    {
        set_name("DistributedATS_MarketDataIncrementalRefresh::MarketDataIncrementalRefresh");
        uint32_t type_size = DistributedATS_MarketDataIncrementalRefresh_MarketDataIncrementalRefresh_max_cdr_typesize;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
        uint32_t key_length = DistributedATS_MarketDataIncrementalRefresh_MarketDataIncrementalRefresh_max_key_cdr_typesize > 16 ? DistributedATS_MarketDataIncrementalRefresh_MarketDataIncrementalRefresh_max_key_cdr_typesize : 16;
        key_buffer_ = reinterpret_cast<unsigned char*>(malloc(key_length));
        memset(key_buffer_, 0, key_length);
    }
