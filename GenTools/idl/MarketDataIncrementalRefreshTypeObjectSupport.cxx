        ...
        TypeIdentifierPair& type_ids_NoMDEntries)
{
    ...
    return_code_NoMDEntries =
        ...
        "DistributedATS_MarketDataIncrementalRefresh::NoMDEntries", type_ids_NoMDEntries);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntries)
    {
        StructTypeFlag struct_flags_NoMDEntries = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_NoMDEntries = "DistributedATS_MarketDataIncrementalRefresh::NoMDEntries";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedATS_MarketDataIncrementalRefresh::NoMDEntries already registered in TypeObjectRegistry for a different type.");
        }
    }
}
        ...
        TypeIdentifierPair& type_ids_NoMDEntriesSeq)
{
    ...
    return_code_NoMDEntriesSeq =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "DistributedATS_MarketDataIncrementalRefresh::NoMDEntriesSeq", type_ids_NoMDEntriesSeq);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntriesSeq)
    {
        AliasTypeFlag alias_flags_NoMDEntriesSeq = 0;
        QualifiedTypeName type_name_NoMDEntriesSeq = "DistributedATS_MarketDataIncrementalRefresh::NoMDEntriesSeq";
        ...
        return_code_NoMDEntriesSeq =
            eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
            "anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded", type_ids_NoMDEntriesSeq);

        if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntriesSeq)
        {
            return_code_NoMDEntriesSeq =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "DistributedATS_MarketDataIncrementalRefresh::NoMDEntries", type_ids_NoMDEntriesSeq);

            if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntriesSeq)
            {
                DistributedATS_MarketDataIncrementalRefresh::register_NoMDEntries_type_identifier(type_ids_NoMDEntriesSeq);
            }
            bool element_identifier_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded_ec {false};
            TypeIdentifier* element_identifier_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded {new TypeIdentifier(TypeObjectUtils::retrieve_complete_type_identifier(type_ids_NoMDEntriesSeq, element_identifier_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded_ec))};
            ...
            EquivalenceKind equiv_kind_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded = EK_COMPLETE;
            if (TK_NONE == type_ids_NoMDEntriesSeq.type_identifier2()._d())
            {
                equiv_kind_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded = EK_BOTH;
            }
            CollectionElementFlag element_flags_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded = 0;
            PlainCollectionHeader header_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded = TypeObjectUtils::build_plain_collection_header(equiv_kind_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded, element_flags_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded);
            {
                SBound bound = 0;
                PlainSequenceSElemDefn seq_sdefn = TypeObjectUtils::build_plain_sequence_s_elem_defn(header_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded, bound,
                            eprosima::fastcdr::external<TypeIdentifier>(element_identifier_anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded));
                if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                        TypeObjectUtils::build_and_register_s_sequence_type_identifier(seq_sdefn, "anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded", type_ids_NoMDEntriesSeq))
                {
                    EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                        "anonymous_sequence_DistributedATS_MarketDataIncrementalRefresh_NoMDEntries_unbounded already registered in TypeObjectRegistry for a different type.");
                }
            }
        }
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION, "DistributedATS_MarketDataIncrementalRefresh::NoMDEntriesSeq related TypeIdentifier inconsistent.");
            return;
        }
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                "DistributedATS_MarketDataIncrementalRefresh::NoMDEntriesSeq already registered in TypeObjectRegistry for a different type.");
        }
    }
}
        ...
        TypeIdentifierPair& type_ids_MarketDataIncrementalRefresh)
{
    ...
    return_code_MarketDataIncrementalRefresh =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "DistributedATS_MarketDataIncrementalRefresh::MarketDataIncrementalRefresh", type_ids_MarketDataIncrementalRefresh);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_MarketDataIncrementalRefresh)
    {
        StructTypeFlag struct_flags_MarketDataIncrementalRefresh = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_MarketDataIncrementalRefresh = "DistributedATS_MarketDataIncrementalRefresh::MarketDataIncrementalRefresh";
        ...
        }
        {
            ...
            ann_custom_MarketDataIncrementalRefresh.reset();
            CompleteMemberDetail detail_DATS_Source = TypeObjectUtils::build_complete_member_detail(name_DATS_Source, member_ann_builtin_DATS_Source, ann_custom_MarketDataIncrementalRefresh);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_MarketDataIncrementalRefresh, member_DATS_Source);
        }
        {
            ...
            ann_custom_MarketDataIncrementalRefresh.reset();
            CompleteMemberDetail detail_DATS_Destination = TypeObjectUtils::build_complete_member_detail(name_DATS_Destination, member_ann_builtin_DATS_Destination, ann_custom_MarketDataIncrementalRefresh);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_MarketDataIncrementalRefresh, member_DATS_Destination);
        }
        {
            ...
            ann_custom_MarketDataIncrementalRefresh.reset();
            CompleteMemberDetail detail_DATS_SourceUser = TypeObjectUtils::build_complete_member_detail(name_DATS_SourceUser, member_ann_builtin_DATS_SourceUser, ann_custom_MarketDataIncrementalRefresh);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_MarketDataIncrementalRefresh, member_DATS_SourceUser);
        }
        {
            ...
            ann_custom_MarketDataIncrementalRefresh.reset();
            CompleteMemberDetail detail_DATS_DestinationUser = TypeObjectUtils::build_complete_member_detail(name_DATS_DestinationUser, member_ann_builtin_DATS_DestinationUser, ann_custom_MarketDataIncrementalRefresh);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_MarketDataIncrementalRefresh, member_DATS_DestinationUser);
        }
        {
        ...
        }
        {
            ...
            return_code_c_NoMDEntries =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "DistributedATS_MarketDataIncrementalRefresh::NoMDEntriesSeq", type_ids_c_NoMDEntries);

            if (eprosima::fastdds::dds::RETCODE_OK != return_code_c_NoMDEntries)
            {
                DistributedATS_MarketDataIncrementalRefresh::register_NoMDEntriesSeq_type_identifier(type_ids_c_NoMDEntries);
            }
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedATS_MarketDataIncrementalRefresh::MarketDataIncrementalRefresh already registered in TypeObjectRegistry for a different type.");
        }
    }
}
