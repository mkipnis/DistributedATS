...
/*!
 * @file OrderCancelReplaceRequestTypeObject.cpp
...
void registerOrderCancelReplaceRequestTypes()
{
    ...
    std::call_once(once_flag, []()
            {
                ...
                factory->add_type_object("DistributedATS_OrderCancelReplaceRequest::OrderCancelReplaceRequest", DistributedATS_OrderCancelReplaceRequest::GetOrderCancelReplaceRequestIdentifier(true),
                        DistributedATS_OrderCancelReplaceRequest::GetOrderCancelReplaceRequestObject(true));
                factory->add_type_object("DistributedATS_OrderCancelReplaceRequest::OrderCancelReplaceRequest", DistributedATS_OrderCancelReplaceRequest::GetOrderCancelReplaceRequestIdentifier(false),
                        DistributedATS_OrderCancelReplaceRequest::GetOrderCancelReplaceRequestObject(false));
...
namespace DistributedATS_OrderCancelReplaceRequest {
    ...
    const TypeIdentifier* GetOrderCancelReplaceRequestIdentifier(bool complete)
    {
        const TypeIdentifier * c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("OrderCancelReplaceRequest", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }

        GetOrderCancelReplaceRequestObject(complete); // Generated inside
        return TypeObjectFactory::get_instance()->get_type_identifier("OrderCancelReplaceRequest", complete);
    }

    const TypeObject* GetOrderCancelReplaceRequestObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("OrderCancelReplaceRequest", complete);
        ...
        {
            return GetCompleteOrderCancelReplaceRequestObject();
        }
        //else
        return GetMinimalOrderCancelReplaceRequestObject();
    }

    const TypeObject* GetMinimalOrderCancelReplaceRequestObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("OrderCancelReplaceRequest", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_type_object("OrderCancelReplaceRequest", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("OrderCancelReplaceRequest", false);
    }

    const TypeObject* GetCompleteOrderCancelReplaceRequestObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("OrderCancelReplaceRequest", true);
        ...
        // Header
        type_object->complete().struct_type().header().detail().type_name("OrderCancelReplaceRequest");
        // TODO inheritance
        TypeIdentifier identifier;
        ...
        TypeObjectFactory::get_instance()->add_type_object("OrderCancelReplaceRequest", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("OrderCancelReplaceRequest", true);
    }
