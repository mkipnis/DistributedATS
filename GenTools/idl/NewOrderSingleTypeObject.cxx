...
/*!
 * @file NewOrderSingleTypeObject.cpp
...
void registerNewOrderSingleTypes()
{
    ...
    std::call_once(once_flag, []()
            {
                ...
                factory->add_type_object("DistributedATS_NewOrderSingle::NewOrderSingle", DistributedATS_NewOrderSingle::GetNewOrderSingleIdentifier(true),
                        DistributedATS_NewOrderSingle::GetNewOrderSingleObject(true));
                factory->add_type_object("DistributedATS_NewOrderSingle::NewOrderSingle", DistributedATS_NewOrderSingle::GetNewOrderSingleIdentifier(false),
                        DistributedATS_NewOrderSingle::GetNewOrderSingleObject(false));
...
namespace DistributedATS_NewOrderSingle {
    ...
    const TypeIdentifier* GetNewOrderSingleIdentifier(bool complete)
    {
        const TypeIdentifier * c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("NewOrderSingle", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }

        GetNewOrderSingleObject(complete); // Generated inside
        return TypeObjectFactory::get_instance()->get_type_identifier("NewOrderSingle", complete);
    }

    const TypeObject* GetNewOrderSingleObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("NewOrderSingle", complete);
        ...
        {
            return GetCompleteNewOrderSingleObject();
        }
        //else
        return GetMinimalNewOrderSingleObject();
    }

    const TypeObject* GetMinimalNewOrderSingleObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("NewOrderSingle", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_type_object("NewOrderSingle", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("NewOrderSingle", false);
    }

    const TypeObject* GetCompleteNewOrderSingleObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("NewOrderSingle", true);
        ...
        // Header
        type_object->complete().struct_type().header().detail().type_name("NewOrderSingle");
        // TODO inheritance
        TypeIdentifier identifier;
        ...
        TypeObjectFactory::get_instance()->add_type_object("NewOrderSingle", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("NewOrderSingle", true);
    }
