...
/*!
 * @file OrderMassCancelReportTypeObject.cpp
...
#include "OrderMassCancelReportTypeObject.h"
#include <mutex>
#include <utility>
#include <sstream>
...
void registerOrderMassCancelReportTypes()
{
    ...
    std::call_once(once_flag, []()
            {
                ...
                factory->add_type_object("DistributedATS_OrderMassCancelReport::OrderMassCancelReport", DistributedATS_OrderMassCancelReport::GetOrderMassCancelReportIdentifier(true),
                        DistributedATS_OrderMassCancelReport::GetOrderMassCancelReportObject(true));
                factory->add_type_object("DistributedATS_OrderMassCancelReport::OrderMassCancelReport", DistributedATS_OrderMassCancelReport::GetOrderMassCancelReportIdentifier(false),
                        DistributedATS_OrderMassCancelReport::GetOrderMassCancelReportObject(false));
...
namespace DistributedATS_OrderMassCancelReport {
    ...
    const TypeIdentifier* GetOrderMassCancelReportIdentifier(bool complete)
    {
        const TypeIdentifier * c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("OrderMassCancelReport", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }

        GetOrderMassCancelReportObject(complete); // Generated inside
        return TypeObjectFactory::get_instance()->get_type_identifier("OrderMassCancelReport", complete);
    }

    const TypeObject* GetOrderMassCancelReportObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("OrderMassCancelReport", complete);
        ...
        {
            return GetCompleteOrderMassCancelReportObject();
        }
        //else
        return GetMinimalOrderMassCancelReportObject();
    }

    const TypeObject* GetMinimalOrderMassCancelReportObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("OrderMassCancelReport", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        MinimalStructMember mst_MassCancelResponse;
        mst_MassCancelResponse.common().member_id(memberId++);
        mst_MassCancelResponse.common().member_flags().TRY_CONSTRUCT1(false); // Unsupported
        mst_MassCancelResponse.common().member_flags().TRY_CONSTRUCT2(false); // Unsupported
        mst_MassCancelResponse.common().member_flags().IS_EXTERNAL(false); // Unsupported
        mst_MassCancelResponse.common().member_flags().IS_OPTIONAL(false);
        mst_MassCancelResponse.common().member_flags().IS_MUST_UNDERSTAND(false);
        mst_MassCancelResponse.common().member_flags().IS_KEY(false);
        mst_MassCancelResponse.common().member_flags().IS_DEFAULT(false); // Doesn't apply
        mst_MassCancelResponse.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier("char", false));


        MD5 MassCancelResponse_hash("MassCancelResponse");
        for(int i = 0; i < 4; ++i)
        {
            mst_MassCancelResponse.detail().name_hash()[i] = MassCancelResponse_hash.digest[i];
        }
        type_object->minimal().struct_type().member_seq().emplace_back(mst_MassCancelResponse);
        ...
        TypeObjectFactory::get_instance()->add_type_object("OrderMassCancelReport", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("OrderMassCancelReport", false);
    }

    const TypeObject* GetCompleteOrderMassCancelReportObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("OrderMassCancelReport", true);
        ...
        CompleteStructMember cst_MassCancelResponse;
        cst_MassCancelResponse.common().member_id(memberId++);
        cst_MassCancelResponse.common().member_flags().TRY_CONSTRUCT1(false); // Unsupported
        cst_MassCancelResponse.common().member_flags().TRY_CONSTRUCT2(false); // Unsupported
        cst_MassCancelResponse.common().member_flags().IS_EXTERNAL(false); // Unsupported
        cst_MassCancelResponse.common().member_flags().IS_OPTIONAL(false);
        cst_MassCancelResponse.common().member_flags().IS_MUST_UNDERSTAND(false);
        cst_MassCancelResponse.common().member_flags().IS_KEY(false);
        cst_MassCancelResponse.common().member_flags().IS_DEFAULT(false); // Doesn't apply
        cst_MassCancelResponse.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier("char", false));


        cst_MassCancelResponse.detail().name("MassCancelResponse");

        type_object->complete().struct_type().member_seq().emplace_back(cst_MassCancelResponse);
        ...
        // Header
        type_object->complete().struct_type().header().detail().type_name("OrderMassCancelReport");
        // TODO inheritance
        TypeIdentifier identifier;
        ...
        TypeObjectFactory::get_instance()->add_type_object("OrderMassCancelReport", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("OrderMassCancelReport", true);
    }
