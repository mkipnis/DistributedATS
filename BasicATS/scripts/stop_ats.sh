...
sleep 1
$DATS_HOME/MatchingEngine/scripts/matchingengine.sh stop matching_engine_MARKET_Y.ini

sleep 1
$DATS_HOME/MatchingEngine/scripts/matchingengine.sh stop matching_engine_MARKET_Z.ini
