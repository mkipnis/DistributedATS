...
-- creating traders
call insert_user('TRADER','UST_TRADER_GROUP_A','UST_TRADER_1','UST TRADER 1');
call insert_user('TRADER','UST_TRADER_GROUP_A','UST_TRADER_2','UST TRADER 2');
call insert_user('TRADER','UST_TRADER_GROUP_B','UST_TRADER_3','UST TRADER 3');
call insert_user('TRADER','UST_TRADER_GROUP_B','UST_TRADER_4','UST TRADER 4');
...
call map_user_group_to_market('UST_TRADER_GROUP_A', 'UST_MARKET');
call map_user_group_to_market('UST_TRADER_GROUP_B', 'UST_MARKET');
