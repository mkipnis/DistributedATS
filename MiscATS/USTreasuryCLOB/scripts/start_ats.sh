...
sleep 1
$DATS_HOME/MatchingEngine/scripts/matchingengine.sh start matching_engine_MARKET_UST.ini
...
while true; do 
	...
	$DATS_HOME/MatchingEngine/scripts/matchingengine.sh check matching_engine_MARKET_UST.ini
