...
sleep 1
$DATS_HOME/MatchingEngine/scripts/matchingengine.sh start matching_engine_MARKET_BTC.ini

sleep 1
$DATS_HOME/MatchingEngine/scripts/matchingengine.sh start matching_engine_MARKET_ETH.ini

sleep 1
$DATS_HOME/MatchingEngine/scripts/matchingengine.sh start matching_engine_MARKET_OTHER_COIN.ini
...
while true; do 
	...
	$DATS_HOME/MatchingEngine/scripts/matchingengine.sh check matching_engine_MARKET_BTC.ini
	$DATS_HOME/MatchingEngine/scripts/matchingengine.sh check matching_engine_MARKET_ETH.ini
	$DATS_HOME/MatchingEngine/scripts/matchingengine.sh check matching_engine_MARKET_OTHER_COIN.ini
