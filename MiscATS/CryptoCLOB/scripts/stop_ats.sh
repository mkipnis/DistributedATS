...
sleep 1
$DATS_HOME/scripts/matchingengine.sh stop matching_engine_MARKET_BTC.ini

sleep 1
$DATS_HOME/scripts/matchingengine.sh stop matching_engine_MARKET_ETH.ini

sleep 1
$DATS_HOME/scripts/matchingengine.sh stop matching_engine_MARKET_OTHER_COIN.ini
