...
-- creating traders
call insert_user('TRADER','TRADER_GROUP_A','CRYPTO_TRADER_1','CRYPTO TRADER 1');
call insert_user('TRADER','TRADER_GROUP_A','CRYPTO_TRADER_2','CRYPTO TRADER 2');
call insert_user('TRADER','TRADER_GROUP_B','CRYPTO_TRADER_3','CRYPTO TRADER 3');
call insert_user('TRADER','TRADER_GROUP_C','CRYPTO_TRADER_4','CTYPTO TRADER 4');
...
call map_user_group_to_market('TRADER_GROUP_A', 'BTC_MARKET');
call map_user_group_to_market('TRADER_GROUP_A', 'ETH_MARKET');
call map_user_group_to_market('TRADER_GROUP_A', 'OTHER_COIN_MARKET');

call map_user_group_to_market('TRADER_GROUP_B', 'BTC_MARKET');
call map_user_group_to_market('TRADER_GROUP_B', 'ETH_MARKET');

call map_user_group_to_market('TRADER_GROUP_C', 'OTHER_COIN_MARKET');
