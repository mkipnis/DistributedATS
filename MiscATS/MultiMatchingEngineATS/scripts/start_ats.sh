...
sleep 1
$DATS_HOME/scripts/matchingengine.sh start matching_engine_MARKET_Y.ini

sleep 1
$DATS_HOME/scripts/matchingengine.sh start matching_engine_MARKET_Z.ini
...
while true; do 
	...
	$DATS_HOME/scripts/matchingengine.sh check matching_engine_MARKET_Y.ini
	$DATS_HOME/scripts/matchingengine.sh check matching_engine_MARKET_Z.ini
